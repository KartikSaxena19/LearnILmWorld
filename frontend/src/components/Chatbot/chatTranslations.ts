...
export const chatTranslations: ChatTranslations = {
  en: {
    welcome: "Welcome to LearniLM World!",
    ...
    placeholder: "Ask me anything about LearniLM World...",
  ...
  hi: {
    welcome: "LearniLM World में आपका स्वागत है!",
    ...
    placeholder: "LearniLM World के बारे में कुछ भी पूछें...",
  ...
  sa: {
    welcome: "LearniLM World मध्ये आपले स्वागत आहे!",
    ...
    placeholder: "LearniLM World विषये यत्किंचित् पृच्छतु...",
  ...
  fr: {
    welcome: "Bienvenue sur LearniLM World !",
  ...
  de: {
    welcome: "Willkommen bei LearniLM World!",
    ...
    placeholder: "Fragen Sie mich alles über LearniLM World...",
  ...
  es: {
    welcome: "¡Bienvenido a LearniLM World!",
    ...
    placeholder: "Pregunta lo que quieras sobre LearniLM World...",
  ...
  ja: {
    ...
    placeholder: "LearniLM Worldについて何でも聞いてください...",
